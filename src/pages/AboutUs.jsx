import mercart from '../assets/mercart.png';
...
export default function AboutUs() {
  return (
    <div style={{display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', marginTop:'20px'}}>
      ...
      <img src={mercart} alt="DevShop Logo" className="about-logo" style={{height:'420px',width:'450px', margin:'10px', borderRadius:'25px'}} />
...
<section style={{display:'flex',flexDirection:'column', justifyContent:'space-around', margin:'20px'}}>
    <div style={{margin:'20px', textAlign:'center'}}>
        ...
        <div style={{display:'flex', flaxdirection:'row', justifyContent:'space-around', alignContent:'center'}}>
            ...
            <img src={mision} alt="DevShop Logo" className="about-logo" style={{height:'350px',width:'480px', margin:'10px', borderRadius:'25px'}} />
        </div>
    </div>
    <div style={{margin:'20px', textAlign:'center'}}>
        <h1>Nuestra visión</h1>
        <div style={{display:'flex', flaxdirection:'row', justifyContent:'space-around', alignContent:'center'}}>
            <img src={vision} alt="DevShop Logo" className="about-logo" style={{height:'320px', margin:'10px', borderRadius:'25px'}} />
